...
![Eclipse 2026-6](images/R/splash.png)
...
https://ftp.halifax.rwth-aachen.de/eclipse/technology/epp/downloads/release/2026-06/R/eclipse-jee-2026-06-R-win32-x86_64.zip
...
downloadfile: {
  ...
  files: {
    'eclipse.zip': 'https://ftp.halifax.rwth-aachen.de/eclipse/technology/epp/downloads/release/2026-06/R/eclipse-jee-2026-06-R-win32-x86_64.zip'
  }
},
```
...
URL for Eclipse JEE: [Mirror 1045](https://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/2026-06/R/eclipse-jee-2026-06-R-win32-x86_64.zip&mirror_id=1045)

### Eclipse installation

- Eclipse Update site: 2026-06 - https://download.eclipse.org/releases/2026-06
